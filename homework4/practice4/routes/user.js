...
router.post('/signup', async (req,res)=> {  
  ...
  //사용중인 아이디가 있는 확인
  if(await User.checkUser(id)) { // User.checkUser가 false 면 회원가입된 아이디가 없다. return값이 bool타입
...
res.status(statusCode.OK)
    .send(util.success(statusCode.OK, responseMessage.CREATED_USER, {userId: idx}));
});
